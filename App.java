...
public class App 
{
    public static void main( String[] args )
    {
        ...
        String environmentId = 
        		"60a93d55-3a70-458e-9d2c-148be2817131";
        String collectionId = 
        		"bb70f2b2-cb3c-40ad-8c2d-484a1405eb08";
        QueryOptions queryOptions = 
        		new QueryOptions.Builder(environmentId, 
        				collectionId).build();
        QueryResponse queryResponse = 
        		service.query(queryOptions).execute();
        
        System.out.println("Empty query.");
        
        Multiple multiple = new Multiple();
        AtTheMovies atTheMovies = new AtTheMovies();
    }
}
